...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(activatedRoute, http, injector, componentFactoryResolver) {
        ...
        this.map = null;
        this.layer = []; // Define our base layers so we can reference them multiple times
        ...
        this.apiBikeData = null;
        this.methode = '';
        this.activatedRoute.queryParams.subscribe(function (params) {
          _this.methode = params['methode'];

          if (_this.methode === "api") {
            ...
            //});
            _this.apiBikeData = {
              "help": "https://www.opengov-muenchen.de/api/3/action/help_show?name=datastore_search_sql",
              "success": true,
              "result": {
                "records": [{
                  "latitude": "48.13192",
                  ...
                  "zaehlstelle": "Arnulf",
                  "longitude": "11.55534",
                  "zaehlstelle_lang": "Arnulfstr. 9 - 11 S\xFCdseite"
                }, {
                  "latitude": "48.12194",
                  "sum": "4863",
                  "zaehlstelle": "Kreuther",
                  "longitude": "11.62417",
                  "zaehlstelle_lang": "Bad-Kreuther-Str."
                }, {
                  "latitude": "48.16887",
                  "sum": "33407",
                  "zaehlstelle": "Olympia",
                  "longitude": "11.55005",
                  "zaehlstelle_lang": "Rudolf-Harbig-Weg (Olympia Park)"
                }, {
                  "latitude": "48.14438",
                  "sum": "23685",
                  "zaehlstelle": "Hirsch",
                  "longitude": "11.51794",
                  "zaehlstelle_lang": "Birketweg HLP (Hirschgarten)"
                }, {
                  "latitude": "48.12032",
                  "sum": "54815",
            ...
            _this.displayApiData();
          } else if (_this.methode === "heat") {
            _this.drawheatmap();
          } else {
            if (_this.map != null) _this.repaint(_this.map);
          }
        });
      }
      ...
      _createClass(AppComponent, [{
        ...
        value: function drawheatmap() {
          ...
          var xx = 0.0015;
          var yy = 0.003;
          var startLat = 48.133447;
          var startLon = 11.533672;
          var lat = startLat;
          var lon = startLon;
          var bla = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]().domain([1, 100]).range(['#1aed36', '#f51e0f']);

          for (var y = 0; y < ySize; y++) {
            for (var x = 0; x < xSize; x++) {
              lon += boxSizeY;
              var startpos = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat, lon);
              var startpos2 = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat + boxSizeX, lon);
              var startpos4 = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat, lon - boxSizeY);
              var startpos3 = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat + boxSizeX, lon - boxSizeY);
              var array1 = [startpos, startpos2, startpos3, startpos4];
              var array = [new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat + xx, lon - xx), new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat + xx, lon + xx), new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat, lon + yy), new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat - xx, lon + xx), new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat - xx, lon - xx), new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat, lon - yy)];
              var rndm = Math.random() * 100;
              var poly = new leaflet__WEBPACK_IMPORTED_MODULE_1__["Polygon"](array, {
                color: bla(rndm),
                weight: 0,
                opacity: 1,
                fillOpacity: .4
            ...
            lon = startLon;
            lat += boxSizeX * 0.5;
            if (y % 2 == 0) lon += boxSizeY * 0.5;
          }
        }
      }, {
        key: "displayApiData",
        value: function displayApiData() {
          var map = this.map;
          ...
          var records = this.apiBikeData.result.records;
          var colorRange = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]().domain([1, 1000]).range(['#1a05ff', '#1aed36']);
          records.forEach(function (e) {
            var m = Object(leaflet__WEBPACK_IMPORTED_MODULE_1__["marker"])([e.latitude, e.longitude], {
              title: "test",
            ...
            var c = Object(leaflet__WEBPACK_IMPORTED_MODULE_1__["circle"])([e.latitude, e.longitude], {
              radius: e.sum / 90,
        ...
        key: "handleMapZoomEnd",
        value: function handleMapZoomEnd(e) {
          if (this.checkIfRepaint()) {
            this.repaint(e.sourceTarget);
          }
        }
        ...
        key: "transformRange",
        value: function transformRange(value, r1, r2) {
          var scale = (r2.max - r2.min) / (r1.max - r1.min);
          return (value - r1.min) * scale;
        }
      }, {
        key: "repaint",
        value: function repaint(map) {
          var _this2 = this;

          this.layer.forEach(function (e) {
            return map.removeLayer(e);
          });
          this.layer = [];
          var routes = [[48.143487, 11.573688, 48.145355, 11.574643], [48.144547, 11.569761, 48.143487, 11.573688], [48.144547, 11.569761, 48.145149, 11.569493], [48.145149, 11.569493, 48.146881, 11.570598], [48.146881, 11.570598, 48.146144, 11.573248], [48.146144, 11.573248, 48.148198, 11.574578], [48.145149, 11.569493, 48.144886, 11.568565], [48.144886, 11.568565, 48.14540983185189, 11.566574500926862], [48.14540983185189, 11.566574500926862, 48.14759057452225, 11.568006800540815], [48.14759057452225, 11.568006800540815, 48.14687925997293, 11.5705978144492], [48.14687925997293, 11.5705978144492, 48.148200945942314, 11.571461485751996], [48.148200945942314, 11.571461485751996, 48.148978574746735, 11.571938918956647], [48.148978574746735, 11.571938918956647, 48.14818853767597, 11.57461576355351], [48.14482137908321, 11.568645166286359, 48.14432479318699, 11.568940209277997], [48.14432479318699, 11.568940209277997, 48.14455125188449, 11.569707321056256], [48.14432479318699, 11.568940209277997, 48.14268013160753, 11.567899512180219], [48.14268013160753, 11.567899512180219, 48.14342204901308, 11.56535141361607], [48.14342204901308, 11.56535141361607, 48.14540243192876, 11.56660132301701], [48.14268013160753, 11.567899512180219, 48.14416848943745, 11.562679933437238], [48.14267678975468, 11.56785659683598, 48.142323366614725, 11.569256709941754], [48.142323366614725, 11.569256709941754, 48.14274313038679, 11.570570992359052], [48.14274313038679, 11.570570992359052, 48.14430116676012, 11.569460557826886], [48.14614550192693, 11.573145913013349, 48.145427008617894, 11.574685500987897], [48.145427008617894, 11.574685500987897, 48.14553176439489, 11.577308701404462], [48.14553176439489, 11.577308701404462, 48.14577969382124, 11.574835704692731], [48.14577969382124, 11.574835704692731, 48.146177953450305, 11.573274659046064], [48.146177953450305, 11.573274659046064, 48.145146384799276, 11.572668479808698], [48.145146384799276, 11.572668479808698, 48.14586679054953, 11.570066737064252], [48.145146384799276, 11.572668479808698, 48.14396708249312, 11.57186381710423], [48.143384580197015, 11.572545098194013, 48.1427519575768, 11.570544170268903], [48.1427519575768, 11.570544170268903, 48.14219807823002, 11.570903586276899], [48.14219807823002, 11.570903586276899, 48.141651352166264, 11.57135956180943], [48.141651352166264, 11.57135956180943, 48.142235782779004, 11.573167370685468], [48.142235782779004, 11.573167370685468, 48.143414408261584, 11.573752092250714], [48.14345473711963, 11.573564337619672, 48.1428149562679, 11.57288305652989], [48.1428149562679, 11.57288305652989, 48.14221251468234, 11.570938454994092], [48.14221251468234, 11.570938454994092, 48.14164204401452, 11.569256709941754], [48.14164204401452, 11.569256709941754, 48.14211681997819, 11.568417178520093], [48.14211681997819, 11.568417178520093, 48.14244482922053, 11.568725632556806], [48.14211681997819, 11.568417178520093, 48.14094723275521, 11.567124353774915], [48.141386218677916, 11.567556189426313, 48.142666404032354, 11.567886101135144], [48.145421277677414, 11.566563772090802, 48.14596760530589, 11.56473718775166], [48.146390918575705, 11.564168559440503, 48.148325970308754, 11.565431879886518], [48.148325970308754, 11.565431879886518, 48.147623136873136, 11.568079220184217]];
          var zoomlevel = 10 - Math.abs(this.transformRange(map.getZoom(), {
            max: 10,
            min: 20
          }, {
            max: 1,
          ...
          var colorRange = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]().domain([1, 100]).range(['#1aed36', '#f51e0f']);
          routes.forEach(function (e) {
            var polyLine = new leaflet__WEBPACK_IMPORTED_MODULE_1__["Polyline"]([new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](e[0], e[1]), new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](e[2], e[3])], {
              color: colorRange(Math.random() * 100),
              opacity: 1,
              weight: zoomlevel
            });
            polyLine.on('click', function (f) {
              console.log(f);
            });
            polyLine.bindPopup("<b>Das Hier</b><br>könnte auch ein Diagramm sein").openPopup();
            map.addLayer(polyLine);

            _this2.layer.push(polyLine);
          });
        }
      }, {
        key: "onMapReady",
        value: function onMapReady(map) {
          ...
          if (this.methode == null) {//this.repaint(this.map);
          }
        }
      }]);
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("leafletMapReady", function AppComponent_Template_div_leafletMapReady_0_listener($event) {
            return ctx.onMapReady($event);
          })("leafletMapMoveEnd", function AppComponent_Template_div_leafletMapMoveEnd_0_listener($event) {
            return ctx.handleMapMoveEnd($event);
          })("leafletMapZoomEnd", function AppComponent_Template_div_leafletMapZoomEnd_0_listener($event) {
            return ctx.handleMapZoomEnd($event);
          });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _my_line_chart_my_line_chart_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"], _asymmetrik_ngx_leaflet__WEBPACK_IMPORTED_MODULE_7__["LeafletModule"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["RouterModule"].forRoot([]), _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_10__["ChartsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _overview_overview_component__WEBPACK_IMPORTED_MODULE_4__["OverviewComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _filter_filter_component__WEBPACK_IMPORTED_MODULE_6__["FilterComponent"], _my_line_chart_my_line_chart_component__WEBPACK_IMPORTED_MODULE_11__["MyLineChartComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"], _asymmetrik_ngx_leaflet__WEBPACK_IMPORTED_MODULE_7__["LeafletModule"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["RouterModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_10__["ChartsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppMyLineChartMyLineChartComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(MyLineChartComponent, [{
        ...
        value: function pushOne() {
          ...
          this.lineChartData.forEach(function (x, i) {
            var num = _this3.generateNumber(i);
        ...
        value: function changeLabel() {
          this.lineChartLabels[2] = ['1st Line', '2nd Line']; // this.chart.update();
        }
      }]);
    ...
    MyLineChartComponent.ɵfac = function MyLineChartComponent_Factory(t) {
      return new (t || MyLineChartComponent)();
    };
    ...
    MyLineChartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 6,
      consts: [[1, "display:", "block;", 2, "width", "100%", "height", "100%"], ["baseChart", "", "width", "800", "height", "800", 2, "width", "100%", "display", "block", 3, "datasets", "labels", "options", "colors", "legend", "chartType", "chartHover", "chartClick"]],
      template: function MyLineChartComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("chartHover", function MyLineChartComponent_Template_canvas_chartHover_1_listener($event) {
            return ctx.chartHovered($event);
          })("chartClick", function MyLineChartComponent_Template_canvas_chartClick_1_listener($event) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\DE116615\Documents\dev\demoTrafficViz\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
