...
class AppComponent {
    constructor(activatedRoute, http, injector, componentFactoryResolver) {
    ...
    drawheatmap() {
        ...
        for (let y = 0; y < ySize; y++) {
            for (let x = 0; x < xSize; x++) {
                lon += boxSizeY;
                const startpos = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat, lon);
                const startpos2 = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat + boxSizeX, lon);
                const startpos4 = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat, lon - boxSizeY);
                const startpos3 = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat + boxSizeX, lon - boxSizeY);
                const array1 = [startpos, startpos2, startpos3, startpos4];
                const array = [
                    new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat + xx, lon - xx),
                    new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat + xx, lon + xx),
                    new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat, lon + yy),
                    new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat - xx, lon + xx),
                    new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat - xx, lon - xx),
                    new leaflet__WEBPACK_IMPORTED_MODULE_1__["LatLng"](lat, lon - yy)
                ];
                const rndm = Math.random() * 100;
                const poly = new leaflet__WEBPACK_IMPORTED_MODULE_1__["Polygon"](array, {
                    color: bla(rndm),
                    weight: 0,
                    opacity: 1,
                    fillOpacity: .4
    ...
    displayApiData() {
        ...
        const colorRange = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]().domain([1, 1000]).range(['#1a05ff', '#1aed36']);
        records.forEach(e => {
            const m = Object(leaflet__WEBPACK_IMPORTED_MODULE_1__["marker"])([e.latitude, e.longitude], {
                title: "test",
            ...
            const c = Object(leaflet__WEBPACK_IMPORTED_MODULE_1__["circle"])([e.latitude, e.longitude], {
                radius: e.sum / 90,
    ...
    repaint(map) {
        ...
        const colorRange = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]().domain([1, 100]).range(['#1aed36', '#f51e0f']);
        routes.forEach(e => {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ComponentFactoryResolver"] }]; }, null); })();
...
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ng2-charts */ "./node_modules/ng2-charts/__ivy_ngcc__/fesm2015/ng2-charts.js");
/* harmony import */ var _my_line_chart_my_line_chart_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./my-line-chart/my-line-chart.component */ "./src/app/my-line-chart/my-line-chart.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        ...
        _my_line_chart_my_line_chart_component__WEBPACK_IMPORTED_MODULE_11__["MyLineChartComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"],
        _asymmetrik_ngx_leaflet__WEBPACK_IMPORTED_MODULE_7__["LeafletModule"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["RouterModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"],
        ng2_charts__WEBPACK_IMPORTED_MODULE_10__["ChartsModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"],
                    _filter_filter_component__WEBPACK_IMPORTED_MODULE_6__["FilterComponent"],
                    _my_line_chart_my_line_chart_component__WEBPACK_IMPORTED_MODULE_11__["MyLineChartComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyLineChartComponent", function() { return MyLineChartComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
MyLineChartComponent.ɵfac = function MyLineChartComponent_Factory(t) { return new (t || MyLineChartComponent)(); };
MyLineChartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MyLineChartComponent, selectors: [["app-my-line-chart"]], decls: 2, vars: 6, consts: [[1, "display:", "block;", 2, "width", "100%", "height", "100%"], ["baseChart", "", "width", "800", "height", "800", 2, "width", "100%", "display", "block", 3, "datasets", "labels", "options", "colors", "legend", "chartType", "chartHover", "chartClick"]], template: function MyLineChartComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "canvas", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("chartHover", function MyLineChartComponent_Template_canvas_chartHover_1_listener($event) { return ctx.chartHovered($event); })("chartClick", function MyLineChartComponent_Template_canvas_chartClick_1_listener($event) { return ctx.chartClicked($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MyLineChartComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
